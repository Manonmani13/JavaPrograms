...
public class ReminderService {
     ...
     public void deleteViaId(long id)
    {
     ...
     // Sample data of birthday names mapped to dates (you can replace this with your actual data source)
     ...
     public List<String> getBirthdayNamesForDate(int daysBeforeBirthday) {
         ...
         // Calculate the target date (birthday) by subtracting daysBeforeBirthday from today
		...
		/*
		 * public List<Reminders> getRemindersWithinNextNDays(int n) { LocalDate today =
		 * LocalDate.now(); LocalDate nextDay = today.plusDays(n);
		 * 
		 * // Fetch reminders whose date falls within the next n days return
		 * reminderRepo.findByDateBetween(today, nextDay); }
		 */
